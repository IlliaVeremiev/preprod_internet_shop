...
/**
 * {@link RegistrationServlet} successful test
 * 
...
public class RegistrationServletTest {
	...
	@Test
	public void shouldCreateUserInstanceOnCorrectRequest() throws Exception {
		...
		verify(session, times(1)).setAttribute(SessionAttributes.USER, user);
	}
}
